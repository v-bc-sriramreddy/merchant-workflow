...
// REST URL
$service_url = 'https://ct.soa-gw.canadapost.ca/rs/' . $mailedBy . '/' . $mobo . '/shipment/340531309186521749/price';
...
if (!$xml) {
	...
	if ($xml->{'shipment-price'} ) {
		$shipmentPrice = $xml->{'shipment-price'}->children('http://www.canadapost.ca/ws/shipment-v4');
